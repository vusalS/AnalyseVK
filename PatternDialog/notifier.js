...
Notifier = {
  ...
  initFrameTransport: function () {
    ...
    curNotifier.error_timeout = 1;
    curNotifier.post_message = Notifier.debug || !(browser.opera && intval(browser.version) < 15 || browser.msie || browser.mozilla && intval(browser.version) > 30);
